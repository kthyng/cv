...
\item Thyng, K. M., R. D. Hetland, M. T. Ogle, X. Zhang, F. Chen, L. Campbell, ``Origins of harmful algal blooms along the Texas coast.'' \textit{Limnology and Oceanography: Fluids \& Environment} (in review).

\item Thyng, K. M. and T. Roc, \href{http://pong.tamu.edu/~kthyng/papers/thyng--tidal_current_turbine_power_capture_and_impact_in_an_idealised_channel_simulation--EWTEC2013.pdf}{``Tidal current turbine power capture and impact in an idealised channel simulation,''} \textit{Proceedings European Wave and Tidal Energy Conference}, Aalborg, Denmark, 2013.

\item Thyng, K. M., J. J. Riley, J. Thomson, ``Inference of turbulence parameters from a ROMS simulation using the $k$-$\varepsilon$ closure scheme,'' September 2013. \textit{Ocean Modelling}. doi: http://dx.doi.org/10.1016/j.ocemod.2013.08.008.
...
\item Roc, T., K. M. Thyng and D. Conley, ``Applying a numerical decision-making tool for tidal current turbine (TCT) planning projects to the Puget Sound estuary - Early Results'', \textit{Proc. EWTEC}, 2011.

\item Kawase, M., and K. M. Thyng. ``Three-dimensional Hydrodynamic Modelling of Inland Marine Waters of Washington State, United States, for Tidal Resource and Environmental Impact Assessment.'' \textit{IET Renewable Power Generation}. 4.6 (2010): 568-578. 
%\item Kawase, Mitsuhiro and Thyng, Kristen M. (2009). \href{http://froude.me.washington.edu/papers/kawase2009.pdf}{A Three-Dimensional Hydrodynamic Model of Inland Marine Waters of Washington State, United States, for Tidal Resource and Environmental Impact Assessment}. \textit{Proceedings of the 8th European Wave and Tidal Energy Conference,} Uppsala, Sweden.
...
\item K. M. Thyng, {\bf T. Roc}, ``Tidal current turbine power capture and impact in an idealised channel simulation,'' 10th European Wave and Tidal Energy Conference, Aalborg, Denmark, September 2--5, 2013.
...
\begin{itemize}
  \item 7th U.S. Harmful Algae Symposium travel award (\$500) based on statement
\end{itemize}
...
\item The 12th International workshop on Multi-scale (Un)-structured mesh numerical Modeling for coastal, shelf, and global ocean dynamics, University of Texas, Austin, September 16--19, 2013.
...
\item Guest Lecturer, Python in Geosciences, 2013
