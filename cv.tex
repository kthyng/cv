...
\item Bacosa, H. P., Thyng, K. M., Plunkett, S., Erdner, D. L., Liu, Z. (submitted). The Tarballs on Texas Beaches Following the 2014 Texas City ``Y'' Spill: Modeling, Chemical, and Microbiological Studies. \textit{Marine Pollution Bulletin}.

\item Thyng, K. M., Hetland, R. D., Zimmerle, H. M., DiMarco, S. F. (in revision). Choosing good colormaps: accurate and effective data visualization. \textit{Oceanography}.
...
\item Python for Geoscientists (OCNG 489/689), Spring 2016, undergrad/graduate class (19 students).
